import{_ as r,M as l,p as c,q as d,R as s,t as n,N as a,V as o,a1 as p}from"./framework-7db056f4.js";const m={},v=s("h1",{id:"定制开发环境",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#定制开发环境","aria-hidden":"true"},"#"),n(" 定制开发环境")],-1),u=s("h2",{id:"自行构建开发镜像",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#自行构建开发镜像","aria-hidden":"true"},"#"),n(" 自行构建开发镜像")],-1),b={href:"https://hub.docker.com/r/polardb/polardb_pg_devel/tags",target:"_blank",rel:"noopener noreferrer"},k=s("code",null,"polardb/polardb_pg_devel",-1),g=p(`<p>另外，我们也提供了构建上述开发镜像的 Dockerfile，从 CentOS 7 官方镜像 <code>centos:centos7</code> 开始构建出一个安装完所有开发和运行时依赖的镜像。您可以根据自己的需要在 Dockerfile 中添加更多依赖。以下是手动构建镜像的 Dockerfile 及方法。</p><details class="custom-container details"><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code><span class="token instruction"><span class="token keyword">FROM</span> centos:centos7</span>
